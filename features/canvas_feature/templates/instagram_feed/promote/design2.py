...
class PromoteDesign2:
    ...
    def render(self) -> Image.Image:
        ...
        name_font = load_font("poppins_bold", 88)
        ...
        current_y += name_total_h + 30
        
        draw_text_block(
            draw, desc_lines, desc_font,
            x=name_x, y=current_y,
            color=text_accent, line_spacing=10,
            align="left", max_width=text_area_width,
        )
        ...
        if image_path and os.path.exists(image_path):
            try:
                ...
                desc_line_height = ascent_d + descent_d + 10
