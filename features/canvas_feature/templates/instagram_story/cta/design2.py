"""
Instagram Story — CTA Template — Design 2
...
from features.canvas_feature.canvas import create_canvas, draw_rounded_rect
...
class CtaDesign2:
    ...
    def render(self) -> Image.Image:
        ...
        for bw, bh, btn_text in btn_sizes:
            ...
            draw.text((tx, ty), btn_text, fill=text_white, font=btn_font)
            bx += bw + btn_spacing
