"""
Instagram Story — Promote Template — Design 2 Top
...
class PromoteDesign2Top:
    ...
    def render(self) -> Image.Image:
        ...
        name_font = load_font("poppins_bold", 120)
        
        text_area_width = int(self.width * 0.75)
        ...
        draw_text_block(
            ...
            color=text_white, line_spacing=18,
        ...
        desc_font = load_font("poppins_regular", 48)
        
        desc_lines = wrap_text(description, desc_font, text_area_width)
        current_y += name_total_h + 60
        
        draw_text_block(
            draw, desc_lines, desc_font,
            x=name_x, y=current_y,
            color=text_accent, line_spacing=16,
            align="left", max_width=text_area_width,
        )

        # App Image (-top) flush at bottom middle
        ...
        if image_path and os.path.exists(image_path):
            try:
                ...
                desc_line_height = ascent_d + descent_d + 16
                desc_total_h = len(desc_lines) * desc_line_height
                
                img_top_y = current_y + desc_total_h + 100
                max_img_h = self.height - img_top_y
                max_img_w = int(self.width * 0.9)
