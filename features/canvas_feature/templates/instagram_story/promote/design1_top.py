"""
Instagram Story — Promote Template — Design 1 Top
...
class PromoteDesign1Top:
    ...
    def render(self) -> Image.Image:
        ...
        desc_font = load_font("poppins_regular", 44)
        ...
        if image_path and os.path.exists(image_path):
            try:
                ...
                desc_height = get_text_height(desc_lines, desc_font, line_spacing=12)
                img_top_y = desc_y + desc_height + 100
